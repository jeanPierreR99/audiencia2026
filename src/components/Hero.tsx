...
import { ArrowRight, CalendarDays, Clock3, MapPin, CheckCircle2, ChevronDown } from "lucide-react";
...
const Hero = () => (
    ...
    >
        ...
        >
            <source
                src="https://portal.munitambopata.gob.pe/storage/2025/noticias/1775678764118-24944605.mp4"
                type="video/mp4"
            />
        </video>
                ...
                <div className="grid lg:grid-cols-2 gap-20 items-center py-20 mt-20 md:py-0 md:mt-0">
                    ...
                    >
                        ...
                        <div className="mt-12 flex flex-wrap gap-5">
                            ...
                            {/* <button className="bg-white border border-slate-200 hover:bg-slate-50 px-10 py-5 rounded-2xl font-bold transition-all duration-300 shadow-lg">
                                <span className="flex items-center gap-3">
